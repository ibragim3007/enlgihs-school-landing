...
export const VIDEO_TESTIMONIALS: VideoTestimonial[] = [
  ...
  },
  {
    ...
    text: "Я 2 года учу английский в English Dome, я немного переживала, так как в моей школе не было английского языка, но потом мы нашли эту школу, теперь я понимаю и говорю на английском. У меня самые лучшие оценки в классе!",
    videoUrl: "/assets/review_4.mp4",
  },
];
